...
enum {
	...
	DISPLAY_LCDC = 1,		/* lcdc */
	DISPLAY_TV = 2,		/* TV Out */
	DISPLAY_EXT_MDDI = 3,	/* External MDDI */
	DISPLAY_WRITEBACK = 4,
};
...
enum {
	...
	DISPLAY_2 = 1,		/* attached on second device */
	DISPLAY_3 = 2,              /* attached on third writeback device */
	MAX_PHYS_TARGET_NUM = 3,
};

enum {
	MDSS_PANEL_INTF_INVALID = -1,
	MDSS_PANEL_INTF_DSI = 0,
	MDSS_PANEL_INTF_EDP = 1,
	MDSS_PANEL_INTF_HDMI = 2,
};
...
enum mdss_intf_events {
	MDSS_EVENT_RESET = 1,
	MDSS_EVENT_UNBLANK = 2,
	MDSS_EVENT_PANEL_ON = 3,
	MDSS_EVENT_BLANK = 4,
	MDSS_EVENT_PANEL_OFF = 5,
	MDSS_EVENT_CLOSE = 6,
	MDSS_EVENT_SUSPEND = 7,
	MDSS_EVENT_RESUME = 8,
	MDSS_EVENT_CHECK_PARAMS = 9,
	MDSS_EVENT_CONT_SPLASH_BEGIN = 10,
	MDSS_EVENT_CONT_SPLASH_FINISH = 11,
	MDSS_EVENT_FIRST_FRAME_UPDATE = 12,
	MDSS_EVENT_PANEL_UPDATE_FPS = 13,
	MDSS_EVENT_FB_REGISTERED = 14,
	MDSS_EVENT_FRAME_UPDATE = 15,
	MDSS_EVENT_PANEL_CLK_CTRL = 16,
	MDSS_EVENT_DSI_CMDLIST_KOFF = 17,
	MDSS_EVENT_MDNIE_DEFAULT_UPDATE = 18,
	MDSS_EVENT_ENABLE_PARTIAL_UPDATE = 19,
	MDSS_EVENT_DSI_ULPS_CTRL = 20,
	MDSS_EVENT_REGISTER_RECOVERY_HANDLER = 21,
	MDSS_EVENT_DSI_DYNAMIC_SWITCH = 22,
	MDSS_EVENT_BACKLIGHT_LATE_ON = 23,
};
...
enum dynamic_fps_update {
	DFPS_SUSPEND_RESUME_MODE = 0,
	DFPS_IMMEDIATE_CLK_UPDATE_MODE = 1,
	DFPS_IMMEDIATE_PORCH_UPDATE_MODE = 2,
};

enum lvds_mode {
	LVDS_SINGLE_CHANNEL_MODE = 0,
	LVDS_DUAL_CHANNEL_MODE = 1,
};
...
enum {
	...
	ALPM_MODE_ON = 1,				/* ALPM Mode Status */
	NORMAL_MODE_ON = 2,				/* Normal Mode Status */
	/* Event Flags */
	CHECK_CURRENT_STATUS = 3,		/* Check Current Mode */
	CHECK_PREVIOUS_STATUS = 4,		/* Check Previous Mode */
	STORE_CURRENT_STATUS = 5,		/* Store Current Mode to Previous Mode */
	CLEAR_MODE_STATUS = 6,			/* Clear Status Flag as 0 */
	/* Brightness Flags */
	CHECK_BL_VALUE = 7,
