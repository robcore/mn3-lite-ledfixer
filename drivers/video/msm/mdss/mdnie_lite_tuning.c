...
static DEVICE_ATTR(hijack, 0644, hijack_show, hijack_store);
static DEVICE_ATTR(curve, 0644, curve_show, curve_store);
static DEVICE_ATTR(copy_mode, 0222, NULL, copy_mode_store);
static DEVICE_ATTR(sharpen, 0644, sharpen_show, sharpen_store);
static DEVICE_ATTR(red_red, 0644, red_red_show, red_red_store);
static DEVICE_ATTR(red_green, 0644, red_green_show, red_green_store);
static DEVICE_ATTR(red_blue, 0644, red_blue_show, red_blue_store);
static DEVICE_ATTR(cyan_red, 0644, cyan_red_show, cyan_red_store);
static DEVICE_ATTR(cyan_green, 0644, cyan_green_show, cyan_green_store);
static DEVICE_ATTR(cyan_blue, 0644, cyan_blue_show, cyan_blue_store);
static DEVICE_ATTR(green_red, 0644, green_red_show, green_red_store);
static DEVICE_ATTR(green_green, 0644, green_green_show, green_green_store);
static DEVICE_ATTR(green_blue, 0644, green_blue_show, green_blue_store);
static DEVICE_ATTR(magenta_red, 0644, magenta_red_show, magenta_red_store);
static DEVICE_ATTR(magenta_green, 0644, magenta_green_show, magenta_green_store);
static DEVICE_ATTR(magenta_blue, 0644, magenta_blue_show, magenta_blue_store);
static DEVICE_ATTR(blue_red, 0644, blue_red_show, blue_red_store);
static DEVICE_ATTR(blue_green, 0644, blue_green_show, blue_green_store);
static DEVICE_ATTR(blue_blue, 0644, blue_blue_show, blue_blue_store);
static DEVICE_ATTR(yellow_red, 0644, yellow_red_show, yellow_red_store);
static DEVICE_ATTR(yellow_green, 0644, yellow_green_show, yellow_green_store);
static DEVICE_ATTR(yellow_blue, 0644, yellow_blue_show, yellow_blue_store);
static DEVICE_ATTR(black, 0644, black_crush_show, black_crush_store);
static DEVICE_ATTR(black_red, 0644, black_red_show, black_red_store);
static DEVICE_ATTR(black_green, 0644, black_green_show, black_green_store);
static DEVICE_ATTR(black_blue, 0644, black_blue_show, black_blue_store);
static DEVICE_ATTR(white_red, 0644, white_red_show, white_red_store);
static DEVICE_ATTR(white_green, 0644, white_green_show, white_green_store);
static DEVICE_ATTR(white_blue, 0644, white_blue_show, white_blue_store);
